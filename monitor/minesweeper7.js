 function SendLR1(num){
  ...
  var opt=num;
  var comm=email+ ' Bet on Grid '+opt;
var str='https://sci.libertyreserve.com/en?lr_acc=U9404864&lr_amnt='+amount+'&lr_currency=LRUSD&lr_comments='+comm+'&lr_fee_amnt=0.00&email='+email+'&pay_id='+opt+'&lr_success_url=http://minecash.1station.org/p/successful.html&lr_success_url_method=GET&lr_fail_url=http://minecash.1station.org/p/failed.html&lr_fail_url_method=GET';

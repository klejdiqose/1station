 function SendLR1(num){
  ...
  var opt=num;
  var comm='Bet on Grid '+opt +email;
var str='https://sci.libertyreserve.com/en?lr_acc=U9404864&lr_amnt='+amount+'&lr_currency=LRUSD&lr_merchant_ref=&lr_comments='+comm+'&lr_fee_amnt=0.00&&pay_id='+opt+'&lr_success_url=http://testnewsponsor.blogspot.com/p/successful.html&lr_success_url_method=GET&lr_fail_url=http://testnewsponsor.blogspot.com/p/fail.html&lr_fail_url_method=GET';
